...
const Footer = () => {
  return (
    <main className=' items-center justify-between'>
        ...
        <div className="footer flex justify-center space-between  mt-5 px-14 bg-lime-200 pt-10">
          ...
          <div className="foot3 w-64">
            ...
            <p><b>Website</b> : <u>https://acshr.vercel.app</u></p>
        ...
        <ul className="mt-2 text-black font-bold text-xl mb-2 space-x-12">
         ...
         <hr className="text-black-500"/>© 2024 <u> www.acshr.vercel.app </u> , All rights reserved.</div>
